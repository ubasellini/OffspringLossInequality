...
source("functions/MortSmoothNew.R")

## all countries to be analysed
countries <- c("AGO","AUS","BFA","CHN",
               "CUB","DZA","GHA","GTM","IND","JPN",
               "MLI","MMR","SEN","SLV","TCD","USA",
               "DNK","SWE")

for (jj in 1:length(countries)){
  ## select country of interest
  cou <- countries[jj]
  cat("analyzing country",cou,"\n")
  ## loading data 
